...
On the other hand, if EBD_fields_only is set to FALSE, then nonEBD fields should be present in a returned data frame and the test from above should return TRUE in this chunk.
```{r}
checklists <- get_checklists_dev(database = "AtlasCache", 
                                 ncba_config = ncba_config,
                                 EBD_fields_only = FALSE)
