...
# Function Definition
```{r}
breeding_boxplot_dev <- function(species, data, type="interactive", 
...
```{r}
breeding_boxplot_dev(species, records, type = "non-interactive")
```
...
omit <- c("S7", "M", "NC", "H", "T", "P", "C", "CN", "N", "A", "NB", 
          "FS")
breeding_boxplot_dev(species, records, type = "interactive", pallet="Set3",
                     omit_codes=omit, lump=NULL, drop=TRUE)
```

Make a figure that has a boxplot for each ecoregion.
```{r}
breeding_boxplot_dev(species = species, data = records, type = "ecoregional",
...
breeding_boxplot_dev(species, records, type = "non-interactive", lump=lump)

breeding_boxplot_dev(species, records, type = "interactive", lump=lump)

breeding_boxplot_dev(species, records, type = "ecoregional", lump=lump)
...
breeding_boxplot_dev(species, records, type = "interactive", lump=lumped_codes)
```
...
breeding_boxplot_dev(species, records, type = "non-interactive", omit_codes = omit)

breeding_boxplot_dev(species, records, type = "interactive", omit_codes = omit)

breeding_boxplot_dev(species, records, type = "ecoregional", omit_codes = omit)

```

3. Check that the pallet argument works by assigning a non-default value.
```{r}
breeding_boxplot_dev(species, records, pallet="Spectral")
breeding_boxplot_dev(species, records, pallet="Paired")

breeding_boxplot_dev(species, records, type="non-interactive", pallet="Spectral")
breeding_boxplot_dev(species, records, type="non-interactive", pallet="Paired")
```

4. Check that all breeding codes that are present in the figure when drop is set to "FALSE".
```{r}
breeding_boxplot_dev(species, records, type="non-interactive", drop=FALSE)
breeding_boxplot_dev(species, records, drop=FALSE)
breeding_boxplot_dev(species, records, type="ecoregional", drop=FALSE)
```
...
breeding_boxplot_dev(species, records, type="interactive", drop=TRUE)
breeding_boxplot_dev(species, records, type="non-interactive", drop=TRUE)
breeding_boxplot_dev(species, records, type="ecoregional", drop=TRUE)
