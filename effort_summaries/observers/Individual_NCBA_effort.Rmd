---
title: "Observer obsXXXXXX NCBA Effort"
author: "N.M. Tarr"
...
blocks_path <- "~/ENTERPATHTOBLOCKSHERE/ncba_blocks.shp"

# Path to filter_eBird_sampling.R output (text file)
filtered_checklists <- "~/ENTERPATHHERE/filtered_checklists.txt"

# Observe ID code
observer <- "ENTERCODEHERE"
```
...
checklists <- filter(checklists, (observer_id == observer & project_code == "EBIRD_ATL_NC"))
```
...
ggplot(data=by_locality) +
  ...
  coord_flip() + 
  labs(title="Number of times locations were surveyed",
       caption="Checklists from before 2021 are not included") +
  ylab("Checklists (n)") + 
...
knitr::kable(most_visited, caption="Locations visited by the observer.")
